...
int main(int argc, char ** argv){
  ...
  bombe_t bombeNull = {-1,-1,0};
  bombe_t bombe_vide[9];

  //Initialise les 4 joueurs
  joueur_t joueur1 = {-1, 1, 1, 'E', 0, 0, 1, 1, -11, bombe_vide};
  joueur_t joueur2 = {-2, 9, 13, 'W', 0, 0, 1, 1, -12, bombe_vide};
  joueur_t joueur3 = {-3, 9, 1, 'W', 0, 0, 1, 1, -13, bombe_vide};
  joueur_t joueur4 = {-4, 1, 13, 'E',0, 0, 1, 1, -14, bombe_vide};
  ...
  afficherMap(joueur1, joueur2, joueur3, joueur4, jeu);
